...
-- vicious.widgets.gmailimportant
local gmailimportant = {}
...
local rss = {
  ...
  labelname = {
    "https://mail.google.com/mail/feed/atom/Important",
    "Gmail %- Label"
  },
}
...
-- The 'important' label - doesn't show count correctly ?!
...
return setmetatable(gmailimportant, { __call = function(_, ...) return worker(...) end })
